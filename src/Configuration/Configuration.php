...
class Configuration implements ConfigurableInterface
{
     ...
     *                                                          serialisation to string/json.
     */
    public function init($config = null, $includeSensitive = true): void
    {
     ...
     */
    public function import($config = null): void
    {
        if ($config === null) {
     ...
     */
    public static function instance($config = null): Configuration
    {
     ...
     * @return Configuration
     */
    public function importJson($json): self
    {
     ...
     * @return Configuration
     */
    public function importCloudinaryUrl($cloudinaryUrl): self
    {
     ...
     * @return Configuration
     */
    public function importConfig($otherConfig): self
    {
