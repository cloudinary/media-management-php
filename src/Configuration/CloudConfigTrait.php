...
trait CloudConfigTrait
{
     ...
     * @api
     */
    public function cloudName($cloudName): self
    {
     ...
     * @api
     */
    public function oauthToken($oauthToken): self
    {
     ...
     * @api
     */
    public function signatureAlgorithm($signatureAlgorithm): self
    {
     ...
     * @internal
     */
    abstract public function setCloudConfig($configKey, $configValue): self;
}
