...
abstract class BaseConfigSection implements ConfigurableInterface
{
     ...
     * @internal
     */
    public function isExplicitlySet($name): bool
    {
     ...
     */
    protected static function exportableKeys($includeSensitive = true): array
    {
     ...
     * @return array of keys
     */
    protected static function importableKeys($exportableKeys): array
    {
     ...
     */
    public static function fromJson($json, $includeSensitive = true): BaseConfigSection
    {
     ...
     * @return string
     */
    public function toString($excludedKeys = []): string
    {
