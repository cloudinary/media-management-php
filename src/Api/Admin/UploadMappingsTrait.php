...
trait UploadMappingsTrait
{
     ...
     */
    public function uploadMapping($name): ApiResponse
    {
        $uri    = ApiEndPoint::UPLOAD_MAPPINGS;
        $params = ['folder' => $name];
     ...
     */
    public function deleteUploadMapping($name): ApiResponse
    {
        $uri    = ApiEndPoint::UPLOAD_MAPPINGS;
        $params = ['folder' => $name];
     ...
     */
    public function updateUploadMapping($name, $options = []): ApiResponse
    {
        $uri    = ApiEndPoint::UPLOAD_MAPPINGS;
     ...
     */
    public function createUploadMapping($name, $options = []): ApiResponse
    {
        $uri    = ApiEndPoint::UPLOAD_MAPPINGS;
        $params = array_merge(['folder' => $name], ArrayUtils::whitelist($options, ['template']));
