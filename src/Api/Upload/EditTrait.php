...
trait EditTrait
{
     ...
     */
    public function destroyAsync($publicId, $options = []): PromiseInterface
    {
     ...
     * @see https://cloudinary.com/documentation/image_upload_api_reference#destroy_method
     */
    public function destroy($publicId, $options = []): ApiResponse
    {
     ...
     */
    public function renameAsync($fromPublicId, $toPublicId, $options = []): PromiseInterface
    {
     ...
     */
    public function explicitAsync($publicId, $options = []): PromiseInterface
    {
        $options['public_id'] = $publicId;

        $params = UploadApi::buildUploadParams($options);

        $params = ArrayUtils::blacklist($params, ['eager', 'eager_async', 'eager_notification_url']);
