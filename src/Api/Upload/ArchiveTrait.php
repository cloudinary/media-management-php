...
trait ArchiveTrait
{
     ...
     *
     */
    public function createArchiveAsync($options = [], $targetFormat = null): PromiseInterface
    {
     ...
     *
     */
    public function createArchive($options = [], $targetFormat = null): ApiResponse
    {
     ...
     * @return PromiseInterface
     */
    public function createZipAsync($options = []): PromiseInterface
    {
     ...
     *
     */
    public function createZip($options = []): ApiResponse
    {
     ...
     *
     */
    public function downloadArchiveUrl($options = []): string
    {
     ...
     */
    public function downloadZipUrl($options = []): string
    {
     ...
     * @return string
     */
    public function privateDownloadUrl($publicId, $format, $options = []): string
    {
        $params = ApiUtils::finalizeUploadApiParams([
            "public_id"    => $publicId,
            "format"       => $format,
            "use_asset_id" => ArrayUtils::get($options, "use_asset_id"),
     ...
     */
    public function downloadFolder($folderPath, $options = []): string
    {
     ...
     */
    public function downloadBackedupAsset($assetId, $versionId): string
    {
