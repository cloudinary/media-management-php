...
trait ContextTrait
{
     ...
     */
    public function addContextAsync($context, $publicIds = [], $options = []): PromiseInterface
    {
     ...
     * @see https://cloudinary.com/documentation/image_upload_api_reference#context_method
     */
    public function addContext($context, $publicIds = [], $options = []): ApiResponse
    {
     ...
     * @see https://cloudinary.com/documentation/image_upload_api_reference#context_method
     */
    public function removeAllContextAsync($publicIds = [], $options = []): PromiseInterface
    {
     ...
     * @see https://cloudinary.com/documentation/image_upload_api_reference#context_method
     */
    public function removeAllContext($publicIds = [], $options = []): ApiResponse
    {
     ...
     * @internal
     */
    protected function callContextApiAsync($command, $context, $publicIds = [], $options = []): PromiseInterface
    {
        $params = [
