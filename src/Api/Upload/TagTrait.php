...
trait TagTrait
{
     ...
     * @see https://cloudinary.com/documentation/image_upload_api_reference#tags_method
     */
    public function addTag($tag, $publicIds = [], $options = []): ApiResponse
    {
     ...
     * @see https://cloudinary.com/documentation/image_upload_api_reference#tags_method
     */
    public function removeTag($tag, $publicIds = [], $options = []): ApiResponse
    {
     ...
     * @see https://cloudinary.com/documentation/image_upload_api_reference#tags_method
     */
    public function removeAllTags($publicIds = [], $options = []): ApiResponse
    {
     ...
     * @see https://cloudinary.com/documentation/image_upload_api_reference#tags_method
     */
    public function replaceTag($tag, $publicIds = [], $options = []): ApiResponse
    {
     ...
     * @internal
     */
    protected function callTagsApiAsync($command, $tag, $publicIds = [], $options = []): PromiseInterface
    {
        $params = [
            'tag'        => $tag,
