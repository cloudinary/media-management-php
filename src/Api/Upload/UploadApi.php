...
class UploadApi
{
     ...
     * @internal
     */
    protected static function getUploadApiEndPoint($action, $options = []): string
    {
     ...
     * @return string
     */
    public function getUploadUrl($assetType = AssetType::AUTO, $endPoint = UploadEndPoint::UPLOAD, $params = []): string
    {
     ...
     * @internal
     */
    protected function callUploadApiAsync($endPoint = UploadEndPoint::UPLOAD, $params = [], $options = []): PromiseInterface
    {
     ...
     * @internal
     */
    protected function callUploadApiJsonAsync($endPoint = UploadEndPoint::UPLOAD, $params = [], $options = []): PromiseInterface
    {
