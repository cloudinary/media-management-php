...
class BaseApiClient
{
     ...
     * @internal
     */
    public function getAsync($endPoint, $queryParams = []): PromiseInterface
    {
     ...
     * @internal
     */
    public function get($endPoint, $queryParams = []): ApiResponse
    {
     ...
     * @internal
     */
    public function postJson($endPoint, $parameters = []): ApiResponse
    {
     ...
     *
     */
    public function postJsonAsync($endPoint, $json): PromiseInterface
    {
     ...
     * @internal
     */
    public function delete($endPoint, $fields = []): ApiResponse
    {
     ...
     * @internal
     */
    public function deleteJson($endPoint, $json = []): ApiResponse
    {
     ...
     * @internal
     */
    public function post($endPoint, $parameters = []): ApiResponse
    {
     ...
     * @internal
     */
    public function postAsync($endPoint, $options = []): PromiseInterface
    {
     ...
     * @internal
     */
    public function put($endPoint, $fields): ApiResponse
    {
     ...
     * @return ApiResponse
     */
    public function putJson($endPoint, $json): ApiResponse
    {
     ...
     * @internal
     */
    private function handleApiResponse($response): ApiResponse
    {
        $statusCode = $response->getStatusCode();
