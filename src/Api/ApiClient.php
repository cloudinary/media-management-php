...
class ApiClient extends BaseApiClient
{
     ...
     * @internal
     */
    public function postForm($endPoint, $formParams): ApiResponse
    {
     ...
     * @internal
     */
    public function postFormAsync($endPoint, $formParams): PromiseInterface
    {
     ...
     * @internal
     */
    public function postAndSignFormAsync($endPoint, $formParams): PromiseInterface
    {
     ...
     * @internal
     */
    public function postAndSignJsonAsync($endPoint, $params): PromiseInterface
    {
     ...
     * @internal
     */
    public function postMultiPartAsync($endPoint, $multiPart, $headers = null, $options = []): PromiseInterface
    {
     ...
     *
     */
    public function postMultiPart($endPoint, $multiPart, $headers = null, $options = []): ApiResponse
    {
     ...
     * @internal
     */
    public function postFile($endPoint, $file, $parameters, $options = []): ApiResponse
    {
     ...
     * @internal
     */
    public function postFileAsync($endPoint, $file, $parameters, $options = []): PromiseInterface
    {
     ...
     * @internal
     */
    protected function callAsync($method, $endPoint, $options): PromiseInterface
    {
     ...
     * @internal
     */
    private function postLargeFileAsync($endPoint, $fileHandle, $parameters, $options = []): PromiseInterface
    {
     ...
     *
     */
    protected function postSingleChunkAsync($endPoint, $singleChunk, $parameters, $options = []): PromiseInterface
    {
        $filePart = [
            'name'     => 'file',
     ...
     * @internal
     */
    private static function buildMultiPart($parameters): array
    {
        return array_values(
            ArrayUtils::mapAssoc(
     ...
     * @internal
     */
    protected static function validateAuthorization($cloudConfig, $options): void
    {
