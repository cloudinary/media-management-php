...
namespace Cloudinary\MediaManagement\Utils;
...
class SignatureVerifier
{
     ...
     */
    public static function verifyNotificationSignature($body, $timestamp, $signature, $validFor = 7200): bool
    {
        $paramsArray = [
            'body'      => $body,
            'timestamp' => $timestamp,
     ...
     * @throws InvalidArgumentException in case a mandatory parameter is empty or of wrong type
     */
    public static function verifyApiResponseSignature($publicId, $version, $signature): bool
    {
     ...
     * @throws InvalidArgumentException In case a mandatory parameter is empty or of wrong type
     */
    private static function validateParams($params, $allowedTypes): void
    {
     ...
     * @return bool
     */
    private static function paramValidator($param, $type): bool
    {
     ...
     */
    private static function validateApiSecret($apiSecret): void
    {
     ...
     * @return string
     */
    public static function generateHmac($payloadToSign, $apiSecret): string
    {
