...
class Utils
{
     ...
     * @return string
     */
    public static function boolToIntString($value): string
    {
        if (! is_bool($value)) {
            return $value;
        }
     ...
     * @return string
     */
    public static function normalizeToString($value): string
    {
     ...
     * @return int
     */
    public static function bytesToKB($bytes): int
    {
     ...
     * @return string
     */
    public static function formatSigned($number): string
    {
     ...
     * @return string
     */
    public static function formatSimpleSignature($signature, $length): string
    {
     ...
     * @return string
     */
    public static function sign($content, $secret, $raw = null, $algo = self::ALGO_SHA1): string
    {
