...
abstract class IntegrationTestCase extends CloudinaryTestCase
{
    ...
    const TEST_IMAGE_PATH     = self::TEST_ASSETS_DIR . self::IMAGE_NAME;
    const TEST_IMAGE_GIF_PATH = self::TEST_ASSETS_DIR . self::IMAGE_NAME_GIF;
    const TEST_DOCX_PATH      = self::TEST_ASSETS_DIR . self::DOCX_NAME;
    const TEST_VIDEO_PATH     = self::TEST_ASSETS_DIR . self::VIDEO_NAME;
    ...
    private static array $TEST_ASSETS = [];
